    ...
    <div className="weather5Days_cardWrapper">
      <div className="weather-today">
        <div className="weather5Days_cardCol_1 image-temp">
          ...
          {idWeatherType === 2 && (
            <img src={WT2} alt="Partly cloudy" className="weather-icon" />
          )}
          {idWeatherType === 3 && (
            <img src={WT3} alt="Sunny intervals" className="weather-icon" />
          )}
          {idWeatherType === 4 && (
          ...
          {idWeatherType === 6 && (
            <img src={WT6} alt="Showers/rain" className="weather-icon" />
          )}
          {idWeatherType === 7 && (
            <img src={WT7} alt="Light showers/rain" className="weather-icon" />
          )}
          {idWeatherType === 8 && (
            <img src={WT8} alt="Heavy showers/rain" className="weather-icon" />
          )}
          {idWeatherType === 9 && (
            <img src={WT9} alt="Rain/showers" className="weather-icon" />
          )}
          {idWeatherType === 10 && (
            <img src={WT10} alt="Light rain" className="weather-icon" />
          )}
          {idWeatherType === 11 && (
            <img src={WT11} alt="Heavy rain/showers" className="weather-icon" />
          )}
          {idWeatherType === 12 && (
            <img src={WT12} alt="Intermittent rain" className="weather-icon" />
          )}
          {idWeatherType === 13 && (
            <img
              src={WT13}
          ...
          {idWeatherType === 19 && (
            <img src={WT19} alt="Thunderstorms" className="weather-icon" />
          )}
          {idWeatherType === 20 && (
            <img
              src={WT20}
          ...
          {idWeatherType === 24 && (
            <img src={WT24} alt="Convective clouds" className="weather-icon" />
          )}
          {idWeatherType === 25 && (
            <img src={WT25} alt="Partly cloudy" className="weather-icon" />
          )}
          {idWeatherType === 26 && (
          ...
          {idWeatherType === 28 && (
            <img src={WT28} alt="Snow showers" className="weather-icon" />
          )}
          {idWeatherType === 29 && (
            <img src={WT29} alt="Rain and snow" className="weather-icon" />
          )}
          {idWeatherType === 30 && (
            <img src={WT30} alt="Rain and snow" className="weather-icon" />
          )}
        </div>
